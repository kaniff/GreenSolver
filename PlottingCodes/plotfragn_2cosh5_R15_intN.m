...
%Nref
plot(x,natom(:,k(1))+nmetal(:,k(1)),'LineWidth',3,'Color','b');
plot(x,natom(:,k(2))+nmetal(:,k(2)),'LineWidth',3,'Color','r');
plot(x,natom(:,k(3))+nmetal(:,k(3)),'LineWidth',3,'Color','k');
plot(x,natom(:,k(4))+nmetal(:,k(4)),'LineWidth',3,'Color',[0.7 0 0.7]);%,'LineStyle','-.');
...
filename=sprintf('FragDens_2cosh5_R15_N1');
print(filename,'-dpdf')
